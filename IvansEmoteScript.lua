...
MadeByLabel.Text = "Script made by sfc_ivan"
MadeByLabel.TextScaled = true
MadeByLabel.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
...
MadeByLabel.Position = UDim2.new(0.72, 0, -0.055, 0)
...
local function PlayEmote(name: string, id: IntValue)
    ...
    if LocalPlayer.Character.Humanoid.RigType ~= Enum.HumanoidRigType.R6 then
        ...
        SendNotification("Error", "You Gotta Be R15 To Use This Script!")
    end
end
...
StarterGui:SetCore("SendNotification", {
    Title = "Notification";
    Text = "Ivan's Emote Script";
    Duration = 5;
})

loadstring(game:HttpGet("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source"))()
print("Executed")
warn("There Was A Error Loading Profot")
print("Working")
print("Loaded")
